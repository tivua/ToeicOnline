...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `fk_user_comment` FOREIGN KEY (`userid`) REFERENCES `userEntity` (`userid`)
...
CREATE TABLE `result` (
  ...
  CONSTRAINT `fk_result_user` FOREIGN KEY (`userid`) REFERENCES `userEntity` (`userid`)
...
INSERT INTO `roleEntity` VALUES (1,'ADMIN'),(2,'USER');
